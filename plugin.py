...
class BasePlugin:
    ...
    def check_all(self):
        ...
        if now - self.last_connectivity_check >= self.connectivity_check_interval:
            ...
            # vu le probleme de routage), ou seulement pendant qu'un test WAN2 est
            # en cours en mode Backup - pas de raison de la solliciter en veille
            if self.wan2_mode != "Backup" or self.wan2_active_reason is not None:
